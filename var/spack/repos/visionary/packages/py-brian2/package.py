...
class PyBrian2(PythonPackage):
    ...
    # begin VISIONS (added)
    version("2.8.0.4",
            sha256="0e8268bb042843418d39b8e6db10aa2ce406f0165bef1290f5a20c9a65db8c08",
            url="https://files.pythonhosted.org/packages/source/B/Brian2/brian2-2.8.0.4.tar.gz")  # Note lowercase brian2 for tar ball
    # end VISIONS
    ...
    depends_on("python@3.10:", type=("build", "run"), when="@2.8:")
    ...
    depends_on("py-numpy@1.23.5:", type=("build", "run"), when="@2.8:")
    depends_on("py-cython@0.29:", type=("build", "run"))
    depends_on("py-cython@0.29.21:", type=("build", "run"), when="@2.8:")
    ...
    depends_on("py-setuptools@61:", type=("build", "run"), when="@2.8:")
    depends_on("py-packaging", type=("build", "run"), when="@2.8:")
    depends_on("py-setuptools-scm@6.2: +toml", type=("build"), when="@2.8:")
    # end VISIONS
