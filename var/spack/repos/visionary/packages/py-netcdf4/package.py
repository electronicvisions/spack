...
class PyNetcdf4(PythonPackage):
    ...
    # begin VISIONS: added preferred since 1.6.2 doesn't build
    version("1.5.8", preferred=True, sha256="ca3d468f4812c0999df86e3f428851fb0c17ac34ce0827115c246b0b690e4e84")
    # end VISIONS
