...
class PyAstroid(PythonPackage):
    ...
    depends_on("py-setuptools@62.6:62", when="@2.12.7:2.14", type=("build", "run"))
    depends_on("py-setuptools@64:", when="@2.15:", type=("build", "run"))
    depends_on("py-wheel@0.37.1:0.37", when="@2.12.7:2.14", type="build")
    depends_on("py-wheel@0.37.1:", when="@2.15:", type="build")
    # end VISIONS
