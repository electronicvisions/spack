...
class PyJaxlib(PythonPackage, CudaPackage, ROCmPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        # begin VISIONS (added): rename of float8_e4m3b11 to float8_e4m3b11fnuz
        depends_on("py-ml-dtypes@:0.2", when="@:0.4.14") # upper bound not determined, we know it fails for 0.4.14
        # end VISIONS
