...
class PyPynn(PythonPackage):
    ...
    depends_on('py-numpy@1.8.2:1.23',   type=('run', 'test'), when="@0.9.5")
    depends_on('py-numpy@1.13.0:1.23',  type=('run', 'test'), when="@0.9.6")
    depends_on('py-numpy@1.16.1:1.23',  type=('run', 'test'), when="@0.10.0")
    depends_on('py-numpy@1.18.5:1.23',  type=('run', 'test'), when="@0.10.1")
    depends_on('py-numpy@1.18.5:',      type=('run', 'test'), when="@0.11:")
    # end VISIONS
