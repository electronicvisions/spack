...
class PyPylint(PythonPackage):
    ...
    # begin VISIONS (modified): we can not concretize with upper limit -> removing it worked for us
    depends_on("py-setuptools@62.6:", when="@2.15.0:", type="build")
    # end VISIONS
    ...
    # begin VISIONS (modified): py-astroid@:2.15.5 did not work for us for py-pylint@2.16.2
    depends_on("py-astroid@2.15.6:2.15", when="@2.16:", type=("build", "run"))
    # end VISIONS
