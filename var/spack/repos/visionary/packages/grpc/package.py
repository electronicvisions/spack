...
class Grpc(CMakePackage):
    ...
    # Visibility change in protobuf: https://github.com/protocolbuffers/protobuf/pull/10608
    # available in 3.22: https://github.com/protocolbuffers/protobuf/releases/tag/v22.0
    # v.1.55.0 is the first version relying on it
    depends_on("protobuf@:3.21", when='@:1.54')
